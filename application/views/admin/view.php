    ...
    <nav class="container-fluid sticky-top bg-white p-0">
      <header class="d-flex flex-wrap align-items-center justify-content-between px-4 py-4 m-0 border-bottom">
        <div class="col-1 d-flex align-items-center justify-content-start"> 
            <button onclick="window.location='<?= base_url('admin/cars')?>'" class="btn btn-sm border-secondary rounded-circle text-align-center"><svg class="fab-icon" xmlns="http://www.w3.org/2000/svg" height="18px" fill="currentColor" viewBox="0 0 256 256"><path d="M228,128a12,12,0,0,1-12,12H69l51.52,51.51a12,12,0,0,1-17,17l-72-72a12,12,0,0,1,0-17l72-72a12,12,0,0,1,17,17L69,116H216A12,12,0,0,1,228,128Z"></path></svg></button>
        </div>
        ...
        <div class="row gap-0 p-0 border-bottom">
            ...
            <div class="col-lg-6 bg-white p-5 d-flex flex-column">
                ...
                <div class="col-lg-4 h-100 d-flex align-items-center justify-content-start">
                  ...
                  <div class="col-lg-8">
                    <button type="button" class="btn btn-lg btn-outline-dark w-100 rounded-4" onclick="window.location='<?= base_url('admin/update-car/'.$car['id'])?>'">
                        Update Info
                        <i class="fas fa-pen" style="margin-left: 2px; position: relative; bottom: 2px; font-size: 16px !important"></i>
                    </button>
                  </div>
                </div>
            </div>
