...
<header class="sticky-top d-flex flex-wrap justify-content-between py-3 mb-4 border-bottom bg-primary px-4">
        ...
        <div class="d-flex align-items-center gap-3">
            ...
            <div class="d-none d-md-flex gap-3">
                ...
                <a href="<?= base_url('admin/history') ?>" class="nav-link px-2 text-white">
                ...
                <a href="<?= base_url('admin/notifications') ?>" class="nav-link px-2 text-white align-middle">
                <svg xmlns="http://www.w3.org/2000/svg" class="nav-icon me-1" fill="currentColor" viewBox="0 0 256 256">
                    ...
                    Notifications <span class="badge rounded-circle align-middle" style="background: #1DB954; font-size: 10px"><span class="fw-normal">7</span></span>
                </a>
