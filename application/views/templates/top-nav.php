...
<header class="sticky-top d-flex flex-wrap justify-content-between py-3 mb-4 border-bottom bg-primary px-4">
        ...
        <div class="d-flex align-items-center gap-3">
            ...
            <div class="d-none d-md-flex gap-3">
                <a href="<?= base_url('admin/bookings') ?>" class="nav-link px-2 text-white">Bookings</a>
                <a href="<?= base_url('admin/notifications') ?>" class="nav-link px-2 text-white">Notifications</a>
                <a href="<?= base_url('admin/history') ?>" class="nav-link px-2 text-white">History</a>
            </div>
