    ...
    <div class="modal-content rounded-4 shadow">
      ...
      <div class="modal-body p-5 pt-0">
        <form>
          ...
          <a role="button" href="admin" class="w-100 mb-2 btn btn-lg rounded-3 btn-bd-primary" type="submit">Login</a>
      ...
      <div class="modal-body p-5 pt-0">
        <form>
          ...
          <div class="row">
            <div class="col-md-6">
              <div class="form-floating mb-3">
                <input type="email" class="form-control rounded-3" placeholder="First name" required>
          ...
          <div class="form-floating mb-3">
            <input type="email" class="form-control rounded-3" placeholder="Email" required>
