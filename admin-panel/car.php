            ...
            <div class="col-lg-7 bg-white p-5 d-flex flex-column">
                ...
                <div class="row px-0 d-flex h-100 align-items-end mt-5">
                  ...
                  <div class="col-md-8 mt-2">
                    <button class="px-4 btn btn-lg btn-outline-danger btn-block rounded-4 m-0 d-flex justify-content-between align-items-center w-100" data-bs-toggle="modal" data-bs-target="#bookModal">
